...
The Libraries that were used for the assignment are the caret and the randomForest . These should be first installed and loaded in the working environment.
